    ...
    public class FPEObjectTypeLookup
    {
        ...
        public FPEObjectTypeLookup()
        {
            ...
            try
            {
                ...
                inventoryItemsLookup.Add(FPEInventoryManagerScript.eInventoryItems.APPLE, "Apple");
                ...
                inventoryItemsLookup.Add(FPEInventoryManagerScript.eInventoryItems.SIMPLEKEY, "SimpleKey");
